                ...
                <form method="POST" action="{{ route('tasks.update', $task) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="4"
                            class="mt-1 block w-full rounded border-gray-300 dark:bg-gray-700 dark:text-white">{{ old('description', $task->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('projects.show', $task->project) }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300">
                            Cancel
                        </a>
                    </div>
                </form>
